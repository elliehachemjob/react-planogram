    ...
    <div>
      ...
      <>
        ...
        <div className='plano-inner-page-wrapper'>
            ...
            <div className='fxd-header-sect'>
              ...
              <div className='search-input-cont'>
                <input
                  ...
                  name=''
                  defaultValue=''
                  placeholder='Planogram Quick Search'
                />
              </div>
              <div className='lang-selector-cont'>
                <svg
          ...
          <div className='plano-inner-page-cont'>
            <div className='plano-inner-page-content'>
              <div className='discover-categories-wrapper'>
                <div className='discover-categories-container'>
                  <div className='discover-category impulse'>
                    <div className='category-title'>impulse</div>
                  </div>
                ...
                <div className='discover-categories-container'>
                  <div className='discover-category cg'>
                    <div className='category-title'>c&amp;g</div>
                  </div>
                  <div className='discover-proceed-arrow'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                ...
                <div className='discover-categories-container'>
                  <div className='discover-category retail'>
                ...
                <div className='discover-categories-container'>
                  <div className='discover-category coolers'>
                    <div className='category-title'>coolers</div>
                  </div>
                  <div className='discover-proceed-arrow'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
