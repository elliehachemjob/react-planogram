        ...
        <div className='sub-categories-wrapper'>
          <div className='fxd-header-sect-cont sub-categories'>
            <div className='fxd-header-sect'>
              <div className='fxd-header-content'>Impulse</div>
          ...
          <div className='sub-categories-container'>
            <div className='sub-categories-content'>
              <div className='sub-cats-container'>
                <div className='sub-cats' onclick='subCatsAccordion($(this))'>
                  <div className='sub-cats-title'>Impulse A</div>
                  <div className='sub-cats-sub-title'>
                    1 shelf - main placement
                  </div>
                  <div className='sub-cat-accordion-cont'>
                ...
                <div className='sub-cats-inner-page-cont'>
                  <div className='sub-cats-inner-page'>
                    <div className='sub-cats-inner-page-title'>12 Facings</div>
                    ...
                    <div className='sub-cats-inner-page-flow'>Traffic Flow</div>
                  </div>
                </div>
              </div>
              <div className='sub-cats-container'>
                <div className='sub-cats' onclick='subCatsAccordion($(this))'>
                  <div className='sub-cats-title'>Impulse B</div>
                  <div className='sub-cats-sub-title'>
                    1 shelf - main placement
                  </div>
                  <div className='sub-cat-accordion-cont'>
              ...
              <div className='sub-cats-container'>
                <div className='sub-cats' onclick='subCatsAccordion($(this))'>
                  <div className='sub-cats-title'>Impulse C</div>
                  <div className='sub-cats-sub-title'>
                    1 shelf - main placement
                  </div>
                  <div className='sub-cat-accordion-cont'>
